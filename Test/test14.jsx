/*
  ...
  Логирует каждый шаг в файл и выводит краткий альерт.
*/
(function () {
  ...
  /* 2 точки изображения → страница → pasteboard */
  var pImg00 = [0, 0]; // левый-верхний угол изображения
  var pImg11 = [1, 1]; // 1 мм вниз и вправо

  var pPage00 = img.resolve(pImg00, CoordinateSpaces.INNER_COORDINATES)[0];
  var pPage11 = img.resolve(pImg11, CoordinateSpaces.INNER_COORDINATES)[0];

  var pBoard00 = page.resolve(pPage00, CoordinateSpaces.PARENT_COORDINATES)[0];
  var pBoard11 = page.resolve(pPage11, CoordinateSpaces.PARENT_COORDINATES)[0];
